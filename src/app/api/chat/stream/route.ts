...
ശുദ്ധ മലയാളം:`;
        ...
        logger.info('RAW LLM RESULT: Malayalam Enforcement', 'enforceMalayalam', {
        ...
        // Safety: Don't let enforcement convert a valid answer into a refusal
        const isOriginalRefusal = rawResponse.includes('ക്ഷമിക്കണം') && rawResponse.includes('വിവരങ്ങൾ ഇല്ല');
        const isEnforcedRefusal = enforced.includes('ക്ഷമിക്കണം') && enforced.includes('വിവരങ്ങൾ ഇല്ല');
        if (!isOriginalRefusal && isEnforcedRefusal) {
            logger.warn('Enforcement converted valid answer to refusal — keeping original', 'enforceMalayalam');
            return rawResponse;
        }
        ...
        const stream = new ReadableStream({
            async start(controller) {
                ...
                try {
                    ...
                    console.log(`📋 RAG Result: ${result.text?.length || 0} chars context, ${result.analysis?.documentsUsed || 0} docs used, strategy: ${result.analysis?.retrievalStrategy}, confidence: ${result.analysis?.confidence}`);
...
🚨🚨🚨 വസ്തുത അടിസ്ഥാന ഉത്തരം — നയം 🚨🚨🚨

**താഴെ നൽകിയിരിക്കുന്ന പ്രമാണങ്ങൾ അടിസ്ഥാനമാക്കി ഉത്തരം നൽകുക.**

❌ കർശനമായി നിരോധിച്ചിരിക്കുന്നവ:
1. ❌ പ്രമാണത്തിൽ ഇല്ലാത്ത സംഖ്യകൾ, പേരുകൾ ഒരിക്കലും സ്വയം ഉണ്ടാക്കരുത്
2. ❌ പ്രമാണത്തിൽ പരാമർശിക്കാത്ത പദ്ധതികൾ/സ്ഥാപനങ്ങൾ കണ്ടുപിടിക്കരുത്
3. ❌ സ്ഥിതിവിവരക്കണക്കുകൾ ഒരിക്കലും സ്വയം ഉണ്ടാക്കരുത്

✅ അനുവദനീയമായവ:
4. ✅ പ്രമാണത്തിൽ ഉള്ള വിവരങ്ങൾ ഉപയോഗിച്ച് യുക്തിസഹമായ നിഗമനങ്ങളിൽ എത്താം
   - ഉദാ: "നെൽകൃഷി 1674 ഹെക്ടറിൽ" എന്ന ഡാറ്റ കണ്ടാൽ, "അതെ, കാട്ടാക്കടയിൽ നെൽകൃഷി ഉണ്ട്" എന്ന് ഉത്തരം നൽകാം
   - ഉദാ: പഞ്ചായത്ത് ലിസ്റ്റ് കണ്ടാൽ, "ഈ പഞ്ചായത്തുകൾ ഉൾപ്പെടുന്നു" എന്ന് പറയാം
5. ✅ സംഖ്യകൾ: പ്രമാണത്തിൽ നിന്ന് കൃത്യമായ സംഖ്യ കണ്ടെത്തി ഉദ്ധരിക്കുക
6. ✅ പേരുകൾ: പ്രമാണത്തിൽ നിന്ന് കൃത്യമായ അക്ഷരവിന്യാസം ഉദ്ധരിക്കുക
7. ✅ പ്രമാണത്തിൽ ബന്ധപ്പെട്ട വിവരം ഉണ്ടെങ്കിൽ, അത് ഉപയോഗിച്ച് സഹായകരമായ ഉത്തരം നൽകുക
8. ✅ പ്രമാണത്തിൽ ഒരു വിധത്തിലും ബന്ധപ്പെട്ട വിവരം ഇല്ലെങ്കിൽ മാത്രം: "ക്ഷമിക്കണം, ഈ വിഷയത്തിൽ നിങ്ങളെ സഹായിക്കാൻ എനിക്ക് മതിയായ വിവരങ്ങൾ ഇല്ല."

⚠️ പ്രധാന കുറിപ്പ്: "അറിയില്ല" എന്ന ഉത്തരം അവസാന മാർഗ്ഗം മാത്രമാണ്. പ്രമാണത്തിൽ ഭാഗികമായെങ്കിലും ബന്ധപ്പെട്ട വിവരം ഉണ്ടെങ്കിൽ, ആ വിവരങ്ങൾ ഉപയോഗിച്ച് ഉത്തരം നൽകുക.
...
- വിവരം തീർത്തും ലഭ്യമല്ലെങ്കിൽ: "ക്ഷമിക്കണം, ഈ വിഷയത്തിൽ നിങ്ങളെ സഹായിക്കാൻ എനിക്ക് മതിയായ വിവരങ്ങൾ ഇല്ല. കൂടുതൽ വിവരങ്ങൾക്ക് ദയവായി സന്ദർശിക്കുക: https://kattakadalac.com/"

🎯 ഉത്തരം നൽകുന്നതിന് മുമ്പ് പരിശോധിക്കുക:
□ പ്രമാണത്തിൽ ബന്ധപ്പെട്ട ഏതെങ്കിലും വിവരം ഉണ്ടോ? (ഉണ്ടെങ്കിൽ, ഉത്തരം നൽകുക!)
□ സംഖ്യകളും പേരുകളും പ്രമാണത്തിൽ നിന്ന് മാത്രം എടുക്കുന്നുണ്ടോ?
□ പ്രമാണത്തിൽ തീർത്തും ബന്ധമില്ലാത്ത വിഷയമാണെങ്കിൽ മാത്രം "അറിയില്ല" എന്ന് പറയുന്നുണ്ടോ?
...
� ഉത്തര ശൈലി — ഗുണനിലവാരം:
- ഉത്തരം 50-150 വാക്കുകൾക്കിടയിൽ ആയിരിക്കണം (വളരെ ചെറിയ ഉത്തരങ്ങൾ ഒഴിവാക്കുക)
- ചോദ്യത്തിന് നേരിട്ട് ഉത്തരം നൽകുക, തുടർന്ന് പ്രമാണത്തിൽ ലഭ്യമായ ബന്ധപ്പെട്ട വിശദാംശങ്ങൾ ചേർക്കുക
- സംഖ്യകൾ ഉണ്ടെങ്കിൽ, അവ ഉൾപ്പെടുത്തുക (ഉദാ: എണ്ണം, തുക, വിസ്തീർണ്ണം)
- ലിസ്റ്റ് ചോദ്യങ്ങൾക്ക്: ഇനങ്ങൾ ലിസ്റ്റ് ചെയ്ത ശേഷം ഒരു ചെറിയ സംഗ്രഹ വാക്യം ചേർക്കുക
- ഹ്രസ്വ ചോദ്യങ്ങൾക്ക് (അതെ/ഇല്ല): ഉത്തരം നൽകിയ ശേഷം പ്രമാണത്തിൽ നിന്നുള്ള തെളിവ് ചേർക്കുക
- ❌ ഒരൊറ്റ വാക്യത്തിൽ ഉത്തരം അവസാനിപ്പിക്കരുത് — എപ്പോഴും ഒരു ചെറിയ വിശദീകരണം കൂടി ചേർക്കുക

�📝 ഉദാഹരണങ്ങൾ (ഈ ഫോർമാറ്റ് പിന്തുടരുക):
ചോദ്യം: "What are the hospitals in Kattakada?"
ഉത്തരം: "കാട്ടാക്കട നിയോജക മണ്ഡലത്തിൽ ആകെ 6 ആശുപത്രികൾ പ്രവർത്തിക്കുന്നു. മലയിൻകീഴിൽ താലൂക്ക് ആശുപത്രി, വിളപ്പിലും വിളവൂർക്കലും കമ്മ്യൂണിറ്റി ഹെൽത്ത് സെന്ററുകളും ഉണ്ട്. കാട്ടാക്കട, മാറനല്ലൂർ, പള്ളിച്ചൽ എന്നിവിടങ്ങളിൽ കുടുംബാരോഗ്യ കേന്ദ്രങ്ങൾ പ്രവർത്തിക്കുന്നു. ഈ ആശുപത്രികളിൽ ആകെ 26 ഡോക്ടർമാരും 128 പാരാമെഡിക്കൽ ജീവനക്കാരും സേവനമനുഷ്ഠിക്കുന്നു."

ചോദ്യം: "Is rice cultivation possible in Kattakada?"
ഉത്തരം: "അതെ, കാട്ടാക്കട മണ്ഡലത്തിൽ നെൽകൃഷി നടക്കുന്നുണ്ട്. തിരുവനന്തപുരം ജില്ലയിൽ ആകെ 1,674 ഹെക്ടർ സ്ഥലത്ത് നെൽകൃഷി നടക്കുന്നു. ജില്ലയുടെ ഭൂപ്രകൃതിയിൽ തീരദേശ സമതലങ്ങൾ, ഇടനാട്, മലനാട് എന്നിവ ഉൾപ്പെടുന്നു, ഇത് വൈവിധ്യമാർന്ന വിളകൾക്ക് അനുയോജ്യമാണ്. നെല്ല്, തെങ്ങ്, വാഴ, പച്ചക്കറികൾ എന്നിവയാണ് പ്രധാന കാർഷിക ഉൽപ്പന്നങ്ങൾ."

ചോദ്യം: "Tell me about development projects"
ഉത്തരം: "മണ്ഡലത്തിൽ 26 പ്രധാന റോഡ് പദ്ധതികൾ ഉൾപ്പെടെ നിരവധി വികസന പ്രവർത്തനങ്ങൾ നടന്നുവരുന്നു. കുടുവീട്ട് കടവ് പാലം (₹17 കോടി), മലയിൻകീഴ് ആർട്സ് & സയൻസ് കോളേജ് (₹9.75 കോടി) എന്നിവ പ്രധാന പദ്ധതികളാണ്. കരമന-വെള്ളരട റോഡ് (₹100 കോടി) മണ്ഡലത്തിലെ ഏറ്റവും വലിയ റോഡ് പദ്ധതിയാണ്. വിദ്യാഭ്യാസം, ആരോഗ്യം, കുടിവെള്ളം എന്നീ മേഖലകളിലും സജീവമായ പ്രവർത്തനങ്ങൾ നടക്കുന്നു."

${chatHistory.length > 0 ? `📜 സംഭാഷണ ചരിത്രം (ഈ സന്ദർഭം ഉപയോഗിച്ച് ഫോളോ-അപ്പ് ചോദ്യങ്ങൾക്ക് ഉത്തരം നൽകുക):
${messages.slice(-7, -1).map(m => `${m.role === 'user' ? '👤 ചോദ്യം' : '🤖 ഉത്തരം'}: ${m.content.slice(0, 300)}${m.content.length > 300 ? '...' : ''}`).join('\n')}

⚠️ ഫോളോ-അപ്പ് ചോദ്യങ്ങൾ: ഉപയോക്താവ് "അത്", "ഇത്", "കൂടുതൽ", "അതിൽ", "ഏത്", "biggest", "more", "which" തുടങ്ങിയ പദങ്ങൾ ഉപയോഗിക്കുമ്പോൾ, മുകളിലെ സംഭാഷണ ചരിത്രം നോക്കി എന്താണ് ഉദ്ദേശിക്കുന്നതെന്ന് മനസ്സിലാക്കി ഉത്തരം നൽകുക. സംഭാഷണ ചരിത്രത്തിൽ ഉള്ള വിവരങ്ങൾ ഉപയോഗിച്ച് ഉത്തരം നൽകാം.` : ''}

${result.text ? `**ലഭ്യമായ പ്രമാണങ്ങൾ (${result.analysis?.documentsUsed || 0} രേഖകൾ — ഈ രേഖകളിൽ നിന്ന് ഉത്തരം നൽകുക):**
${result.text}` : (chatHistory.length > 0 ? `**പ്രമാണങ്ങളിൽ നേരിട്ട് ബന്ധപ്പെട്ട വിവരം കണ്ടെത്തിയില്ല. എന്നാൽ സംഭാഷണ ചരിത്രത്തിൽ ബന്ധപ്പെട്ട വിവരങ്ങൾ ഉണ്ടെങ്കിൽ, അത് ഉപയോഗിച്ച് ഉത്തരം നൽകുക. സംഭാഷണ ചരിത്രത്തിലും ബന്ധപ്പെട്ട വിവരം ഇല്ലെങ്കിൽ മാത്രം "ക്ഷമിക്കണം" എന്ന് പറയുക.**` : 'ക്ഷമിക്കണം, ഈ വിഷയത്തിൽ നിങ്ങളെ സഹായിക്കാൻ എനിക്ക് മതിയായ വിവരങ്ങൾ ഇല്ല. കൂടുതൽ വിവരങ്ങൾക്ക് ദയവായി സന്ദർശിക്കുക: https://kattakadalac.com/')}
...
🚫 ഓർമ്മിക്കുക: ഉത്തരം മലയാളത്തിൽ മാത്രം. ഇംഗ്ലീഷ് ഒരിക്കലും ഉപയോഗിക്കരുത്. ഇംഗ്ലീഷ് ചോദ്യത്തിനും മലയാളത്തിൽ മാത്രം ഉത്തരം നൽകുക. 🚫`;
                    ...
                    logger.info('RAW LLM RESULT: Initial Response (Full)', 'api/chat/stream', {
                        rawResponse: fullResponse
                    });
                    console.log(`🔍 First LLM pass (${fullResponse.length} chars): ${fullResponse.slice(0, 300)}...`);
