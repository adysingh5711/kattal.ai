/**
 * GenAI Configuration for Kaattaal AI
...
export const genaiConfig = {
  ...
  aiMetaTags: {
    ...
    // AI Summary
    'ai:summary': 'Kaattaal AI is an advanced AI-powered platform that enables users to chat with PDF documents to instantly understand district information, development data, and government services using natural language processing and vector search technology.',
